...
@interface BonjourSocketClient () <GCDAsyncSocketDelegate, NSNetServiceBrowserDelegate, NSNetServiceDelegate>
...
- (void)connect:(NSNetService *)service{
    ...
    self.clientSocket = [[GCDAsyncSocket alloc] initWithDelegate:self delegateQueue:self.socketQueue];
    self.clientSocket.userData = @"12345678";
